...
const MATERIAL_ROWS: Row<MaterialKey>[] = [
  { key: 'gripperPerLength', label: 'Gripper', unit: 'per length', hint: `One 1.52 m length; trade boxes hold ${GRIPPER_TRADE_BOX}.` },
  ...
  { key: 'primerPerLitre', label: 'Primer', unit: 'per litre', hint: 'Acrylic primer concentrate for use under smoothing compound.' },
